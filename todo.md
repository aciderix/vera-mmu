...
- [ ] §54 — Parité ARET : `C01` (adressage) et `C03` (table `component`) sont `DONE`, leurs tests de parité exécutés contre le DDL réel d'ARET et sa mémoire baseline. Douze couplages de données restent faisables ici ; `C07`/`C08` demandent Wine et MinGW. Le diagnostic « blocage matériel » était faux pour 14 couplages sur 16.

...
- [ ] §54 — Parité ARET : `C01` (adressage) est `DONE`, avec son test de parité exécuté contre la source ARET et la mémoire baseline réelles. Treize couplages de données restent faisables ici ; `C07`/`C08` demandent Wine et MinGW. Le diagnostic « blocage matériel » était faux pour 14 couplages sur 16.

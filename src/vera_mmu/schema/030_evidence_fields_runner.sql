CREATE TABLE capability_contract_m3_18 (
    capability_id TEXT PRIMARY KEY REFERENCES capability(id) ON DELETE RESTRICT,
    runner_profile TEXT NOT NULL CHECK (runner_profile IN ('NOOP', 'EVIDENCE_HASH', 'EVIDENCE_FIELDS')),
...
INSERT INTO capability_contract_m3_18(capability_id, runner_profile, network_policy, timeout_seconds, parameter_schema_json, yields_proof, created_at, created_by)
...
ALTER TABLE capability_contract_m3_18 RENAME TO capability_contract;

...
| `M2` | Persistence universelle | M2.1 : substrate SQLite. M2.2 : types et entités. M2.3 : types relationnels et arêtes. M2.4 : types knowledge et assertions append-only hashées. M2.5 : sources documentaires déclaratives. M2.6 : supersession directe immutable entre knowledge. Sous-lots ultérieurs : Evidence Store et contraintes métier restantes. | M2.1/M2.2/M2.3/M2.4/M2.5/M2.6 validés ; fetch/import de document, mutation de statut, `PROVEN`/evidence, FTS/FIND, traversal/lifecycle, intégrité référentielle étendue et audit métier restent à compléter par sous-lots. | I001–I006, I010, I011, I014, I015 | `IN_PROGRESS` — M2.1/M2.2/M2.3/M2.4/M2.5/M2.6 `PASS`; M2 complet `UNKNOWN` |

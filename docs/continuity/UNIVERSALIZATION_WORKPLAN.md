...
| Révision VERA-MMU | `2ca3235b33d4e0493cce7e9513ac60b3a49f2bab` sur `main`, baseline publiée avant M2.11 ; le patch M2.11 révisé attend son commit atomique. | `OBSERVED` | Journal `LOG-0034`, `LOG-0036`, `LOG-0038`. |
...
| Lot suivant | Aucun sous-lot actif : M2.11 révisé attend seulement son commit/publication atomique. M2.12 exige un rituel distinct et une hypothèse explicitement bornée. | `READY_FOR_M2.12_RITUAL` ; `MEM-WALL-001` préservée | Journal `LOG-0036`, `LOG-0038` ; mémoire section 7. |

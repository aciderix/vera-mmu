...
| Révision VERA-MMU | `3b9f4798fd3385c33c53aea2140326e8cd0bc88a` sur `main`, baseline publiée avant M2.10 ; le patch M2.10 attend son commit atomique. | `OBSERVED` | Journal `LOG-0031`, `LOG-0033`. |
...
| Lot suivant | Aucun sous-lot actif : M2.10 attend seulement son commit/publication atomique. M2.11 exige un rituel distinct et une hypothèse explicitement bornée. | `READY_FOR_M2.11_RITUAL` ; `MEM-WALL-001` préservée | Journal `LOG-0033` ; mémoire section 7. |

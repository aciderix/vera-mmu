...
| Révision VERA-MMU | `fb3b287c1c973ca4d56c317dca899276bb65ccd4` sur `main`, baseline publiée avant M2.8 ; le patch M2.8 attend son commit atomique. | `OBSERVED` | Journal `LOG-0025`, `LOG-0027`. |
...
| Lot suivant | Aucun sous-lot actif : M2.8 attend seulement son commit/publication atomique. M2.9 exige un rituel distinct et une hypothèse explicitement bornée. | `READY_FOR_M2.9_RITUAL` ; `MEM-WALL-001` préservée | Journal `LOG-0027` ; mémoire section 7. |

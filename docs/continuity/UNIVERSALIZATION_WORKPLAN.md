...
| Révision VERA-MMU | M5-J et sa continuité sont publiés jusqu’à `baf690d`; M5-K fonctionnel est committé localement à `df73425` avant sa continuité documentaire. Les jalons fonctionnels `5ffe182`, `5de260d`, `50cc79a`, `e073fa2`, `9010293`, `5dab574`, `ea7235a`, `8b38b1b`, `674929c`, `e576b1a` et `df73425` portent façade, manifeste, registries runtime/lifecycle, adapter/hôte Pack, instructions, config, hooks, plan hôte, installateur, Lifecycle Core et acquittement MCP contextualisé. | `OBSERVED` ; Core, Pack, façade, manifeste, registries, instructions, config, hooks, plan hôte et installateur restent séparés. | `LOG-0182` à `LOG-0193` et artefacts M5 du 26 août 2026. |
...
| Lot suivant | M4.EXIT reste `NOT_ELIGIBLE` pour ses imports, playbook, bundles/VCS et compatibilités restants. M5-A/B/C/D/E/F/G/H/I ont validé transport, manifeste, registry, adapter Pack, instructions, config, hook plan, plan hôte et installateur MCP. M5-J livre le Lifecycle Core et M5-K la liaison MCP/registry attestée sans hôte concret. Le prochain patch autorisé est M5-L : adapter Claude Code local, plan installé opt-in et doctor ; aucun cloud ni bootstrap ne doit être ajouté. Les divergences Wine restent des observations ARET distinctes. | `M5_IN_PROGRESS` ; M5-J/K `PASS`, M5-L `PLANNED`; parité ARET hors conformance de transport | `LOG-0182` à `LOG-0193`; contrats MCP M5-A/B/C/D/E/F/G/H/I/J/K du 26 août 2026. |

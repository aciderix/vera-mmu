...
| Révision VERA-MMU | M5-I et sa continuité sont publiés jusqu’à `f234fc6`. Les jalons fonctionnels `5ffe182`, `5de260d`, `50cc79a`, `e073fa2`, `9010293`, `5dab574`, `ea7235a`, `8b38b1b` et `674929c` portent façade, manifeste, registry, adapter/hôte Pack, instructions, config, hooks, plan hôte et installateur. Le cadrage lifecycle M5-J→M5-Q est consigné séparément avant tout hook exécutable. | `OBSERVED` ; Core, Pack, façade, manifeste, registry, instructions, config, hooks, plan hôte et installateur restent séparés. | `LOG-0182` à `LOG-0191` et artefacts M5 du 26 août 2026. |
...
| Lot suivant | M4.EXIT reste `NOT_ELIGIBLE` pour ses imports, playbook, bundles/VCS et compatibilités restants. M5-A/B/C/D/E/F/G/H/I ont validé transport, manifeste, registry, adapter Pack, instructions, config, hook plan, plan hôte et installateur MCP. `LOG-0191` cadre la reprise fonctionnelle universelle : Lifecycle Core avant adapters Claude/Codex/Gemini/Antigravity, avec niveaux de compatibilité explicites ; le prochain patch autorisé est M5-J et n’installe encore aucun hook. Les divergences Wine restent des observations ARET distinctes. | `M5_IN_PROGRESS` ; M5-J `PLANNED`; parité ARET hors conformance de transport | `LOG-0182` à `LOG-0191`; contrats MCP M5-A/B/C/D/E/F/G/H/I et lifecycle du 26 août 2026. |

...
| Révision VERA-MMU | `34d9c2595ab93c1e041c88fb213451b2b1794929` sur `main`, commit M2.11 révisé publié et vérifié ; le record de publication est consigné dans le commit documentaire suivant. | `OBSERVED` | Journal `LOG-0036`, `LOG-0038`, `LOG-0039`. |
...
| Lot suivant | Aucun sous-lot actif : M2.11 révisé est publié. M2.12 exige un rituel distinct et une hypothèse explicitement bornée. | `READY_FOR_M2.12_RITUAL` ; `MEM-WALL-001` préservée | Journal `LOG-0036`, `LOG-0038`, `LOG-0039` ; mémoire section 7. |
...
| `M2` | Persistence universelle | M2.1 : substrate SQLite. M2.2 : types et entités. M2.3 : types relationnels et arêtes. M2.4 : types knowledge et assertions append-only hashées. M2.5 : sources documentaires déclaratives. M2.6 : supersession directe immutable entre knowledge. M2.7 : assets binaires immuables, hashés avant lecture. M2.8 : associations knowledge–asset déclaratives immuables. M2.9 : index direct et borné de ces associations. M2.10 : sources documentaires déclaratives attachées aux assets. M2.11 : index direct et borné de sources knowledge par hash déclaré. Sous-lots ultérieurs : Evidence Store et contraintes métier restantes. | M2.1/M2.2/M2.3/M2.4/M2.5/M2.6/M2.7/M2.8/M2.9/M2.10/M2.11 validés ; chemin/fichier externe, fetch/import, comparaison source↔asset, mutation de statut, `PROVEN`/evidence, execution/validator/gate, FTS/FIND, recherche libre, traversal/lifecycle, intégrité référentielle étendue et audit métier restent à compléter par sous-lots. | I001–I006, I010, I011, I014, I015 | `IN_PROGRESS` — M2.1/M2.2/M2.3/M2.4/M2.5/M2.6/M2.7/M2.8/M2.9/M2.10/M2.11 `PASS`; M2 complet `UNKNOWN` |

...
| Révision VERA-MMU | M5-M.1 et sa continuité sont publiés jusqu’à `0663f06`; M5-M.2 fonctionnel est committé localement à `f79415b` avant sa continuité documentaire. Les jalons fonctionnels `5ffe182`, `5de260d`, `50cc79a`, `e073fa2`, `9010293`, `5dab574`, `ea7235a`, `8b38b1b`, `674929c`, `e576b1a`, `df73425`, `45fe9af`, `940fb7e` et `f79415b` portent façade, manifeste, registries runtime/lifecycle, adapter/hôte Pack, instructions, config, hooks, plan hôte, installateur, Lifecycle Core, acquittement MCP contextualisé, adapter Claude local, plan/doctor cloud et adapter cloud staged. | `OBSERVED` ; l’adapter cloud staged reste distinct de toute configuration/trust host ou preuve Claude Code web live. | `LOG-0182` à `LOG-0196` et artefacts M5 du 26 août 2026. |
...
| Lot suivant | M4.EXIT reste `NOT_ELIGIBLE` pour ses imports, playbook, bundles/VCS et compatibilités restants. M5-A/B/C/D/E/F/G/H/I ont validé transport, manifeste, registry, adapter Pack, instructions, config, hook plan, plan hôte et installateur MCP. M5-J livre le Lifecycle Core, M5-K la liaison MCP/registry attestée, M5-L le premier adapter Claude Code local opt-in, M5-M.1 le plan/doctor cloud préinstallé et M5-M.2 l’adapter cloud staged. Le prochain patch autorisé est M5-M.3 : preview/merge/trust host cloud et preuve Claude Code web, sans bootstrap réseau ni écriture user-scope sans double confirmation. Les divergences Wine restent des observations ARET distinctes. | `M5_IN_PROGRESS` ; M5-J/K/L/M.1/M.2 `PASS`, M5-M.3 `PLANNED`; parité ARET hors conformance de transport | `LOG-0182` à `LOG-0196`; contrats MCP M5-A/B/C/D/E/F/G/H/I/J/K/L/M.1/M.2 du 26 août 2026. |

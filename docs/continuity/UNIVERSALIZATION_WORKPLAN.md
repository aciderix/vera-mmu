...
| Révision VERA-MMU | M5-L et sa continuité sont publiés jusqu’à `4eac4a9`; M5-M.1 fonctionnel est committé localement à `940fb7e` avant sa continuité documentaire. Les jalons fonctionnels `5ffe182`, `5de260d`, `50cc79a`, `e073fa2`, `9010293`, `5dab574`, `ea7235a`, `8b38b1b`, `674929c`, `e576b1a`, `df73425`, `45fe9af` et `940fb7e` portent façade, manifeste, registries runtime/lifecycle, adapter/hôte Pack, instructions, config, hooks, plan hôte, installateur, Lifecycle Core, acquittement MCP contextualisé, adapter Claude local et plan cloud préinstallé. | `OBSERVED` ; le plan cloud reste distinct de tout runtime, hook, bootstrap ou trust réellement appliqué. | `LOG-0182` à `LOG-0195` et artefacts M5 du 26 août 2026. |
...
| Lot suivant | M4.EXIT reste `NOT_ELIGIBLE` pour ses imports, playbook, bundles/VCS et compatibilités restants. M5-A/B/C/D/E/F/G/H/I ont validé transport, manifeste, registry, adapter Pack, instructions, config, hook plan, plan hôte et installateur MCP. M5-J livre le Lifecycle Core, M5-K la liaison MCP/registry attestée, M5-L le premier adapter Claude Code local opt-in et M5-M.1 le plan/doctor cloud préinstallé. Le prochain patch autorisé est M5-M.2 : adapter Claude Code cloud réellement distribuable, sans déduire un hook, un trust user-scope ou un bootstrap de M5-M.1. Les divergences Wine restent des observations ARET distinctes. | `M5_IN_PROGRESS` ; M5-J/K/L/M.1 `PASS`, M5-M.2 `PLANNED`; parité ARET hors conformance de transport | `LOG-0182` à `LOG-0195`; contrats MCP M5-A/B/C/D/E/F/G/H/I/J/K/L/M.1 du 26 août 2026. |

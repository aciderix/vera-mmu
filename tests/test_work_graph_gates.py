...
class GateTests(unittest.TestCase):
 ...
 def _evidence(self,s):
  CapabilityService(s).create('c','C','CHECK','1.0.0');CapabilityContractService(s).declare('c','NOOP','DENY_NETWORK',30);ExecutionService(s).run_noop('x','c',{});EvidenceService(s).record('e','x','TEST_PROOF','PASS',{})
